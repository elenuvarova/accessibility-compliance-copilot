...
class Component(SQLModel, table=True):
    ...
    issue_count: int = 0           # CONFIRMED issues only
    needs_review: int = 0          # incomplete items (needs_manual) in this group
    pages_affected: int = 0
    debt_score: float = 0.0
    top_severity: str = "minor"    # worst CONFIRMED severity; "review" if confirmed-free
